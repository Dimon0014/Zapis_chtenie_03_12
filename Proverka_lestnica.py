...
while (ik < 1000):
    ...
    raznica=0
    razresh_01= True
    dict_contr_01={"koef":1,"step":0}
    dict_tansf_01 = [0, 0, 0]
    interval_01=0
    razresh_02 = True
    dict_contr_02 = {"koef": 1, "step": 0}
    dict_tansf_02=[0,0,0]
    interval_02 = 0
    razresh_03 = True
    dict_contr_03 = {"koef": 1, "step": 0}
    dict_tansf_03 = [0, 0, 0]
    interval_03 = 0
    while (steps <len(viborka)):
        ...
        if (not razresh_01) and (not razresh_02) and (not razresh_03) :
            razresh_01=True
            razresh_02 = True
            razresh_03 = True
