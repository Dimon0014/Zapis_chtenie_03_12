...
i=0
vse_minusu=[]
for i in range(222,793): #while (ik < 1): # количество файлов
    #ik = ik + 1
    ...
    def upr_stavkami(stavki,schet_shagamm):
        ...
        # elif schet_shagamm > 126 and schet_shagamm < 145:
        #     stavki = stavki * 2
        #     #print(steps,' ',key,'-------------------------------------------------------------------stavka0.64' )
        # elif schet_shagamm > 144 and schet_shagamm < 163:
        #     stavki = stavki * 2
            #print(steps, ' ', key, '-------------------------------------------------------------------stavka1.28')
        elif schet_shagamm > 126:
            stavki  = -1
    ...
    while (steps <len(viborka)):
        ...
        if promegutocnuy_balans > 1:
            ...
            print('na shage: ', steps, 'vysel iz igry')
            break
        # if samauy_minus < -400:
    ...
    print('--------------------------------------------------------------------------------------------------------')
    print('file ',naime_file)
    real_balans = balans+ promegutocnuy_balans2
