...
def funct_obnuleniaja_chisla(buf_play_chisla, best_chislo1):
    if best_chislo1 > -1:
        buf_play_chisla[best_chislo1][9] = 1
    return buf_play_chisla
...
def dubl_finder2(key,dubl_list2):
     ...
     if key == dubl_list2[0]:
        dubl_list2[1]=dubl_list2[1] +35
        dubl_list2[3]=dubl_list2[3]+1
        dubl_list2[2] = dubl_list2[2] + 1

        dubl_list2[0] = dubl_list2[5]
        dubl_list2[5] = key
     else:
        dubl_list2[0] = dubl_list2[5]
        dubl_list2[2] = dubl_list2[2] + 1
     ...
     return  dubl_list2
def dubl_finder3(key,dubl_list3):
    if key == dubl_list3[0]:
        dubl_list3[1]=dubl_list3[1] +35
        dubl_list3[3]=dubl_list3[3]+1
        dubl_list3[2] = dubl_list3[2] + 1
        dubl_list3[0] = dubl_list3[5]
        dubl_list3[5] = dubl_list3[6]
        dubl_list3[6] = key
    else:
        dubl_list3[0] = dubl_list3[5]
        dubl_list3[2] = dubl_list3[2] + 1
        ...
        dubl_list3[6] = key
    return  dubl_list3
def dubl_finder4(key,dubl_list4):
    if key == dubl_list4[0]:
        dubl_list4[1]=dubl_list4[1] +35
        dubl_list4[3]=dubl_list4[3]+1
        dubl_list4[2] = dubl_list4[2] + 1
        dubl_list4[0] = dubl_list4[5]
        dubl_list4[5] = dubl_list4[6]
        dubl_list4[6] = dubl_list4[7]
        dubl_list4[7] = key
    else:
        dubl_list4[0] = dubl_list4[5]
        dubl_list4[2] = dubl_list4[2] + 1
        ...
        dubl_list4[7] = key
    return  dubl_list4
def dubl_finder5(key,dubl_list5):
    if key == dubl_list5[0]:
        dubl_list5[1]=dubl_list5[1] +35
        dubl_list5[3]=dubl_list5[3]+1
        dubl_list5[2] = dubl_list5[2] + 1
        dubl_list5[0] = dubl_list5[5]
        dubl_list5[5] = dubl_list5[6]
        dubl_list5[6] = dubl_list5[7]
        dubl_list5[7] = dubl_list5[8]
        dubl_list5[8] = key
    else:
        dubl_list5[0] = dubl_list5[5]
        dubl_list5[2] = dubl_list5[2] + 1
        ...
        dubl_list5[8] = key
    return  dubl_list5
def dubl_finder6(key,dubl_list6):
    if key == dubl_list6[0]:
        dubl_list6[1]=dubl_list6[1] +35
        dubl_list6[3]=dubl_list6[3]+1
        dubl_list6[2] = dubl_list6[2] + 1
        dubl_list6[0] = dubl_list6[5]
        dubl_list6[5] = dubl_list6[6]
        dubl_list6[6] = dubl_list6[7]
        dubl_list6[7] = dubl_list6[8]
        dubl_list6[8] = dubl_list6[9]
        dubl_list6[9] = key
    else:
        dubl_list6[0] = dubl_list6[5]
        dubl_list6[2] = dubl_list6[2] + 1
...
def dubl_finder7(key,dubl_list7):
    if key == dubl_list7[0]:
        dubl_list7[1]=dubl_list7[1] +35
        dubl_list7[3]=dubl_list7[3]+1
        dubl_list7[2] = dubl_list7[2] + 1
        dubl_list7[0] = dubl_list7[5]
        dubl_list7[5] = dubl_list7[6]
        dubl_list7[6] = dubl_list7[7]
        dubl_list7[7] = dubl_list7[8]
        dubl_list7[8] = dubl_list7[9]
...
for i in range(302,363):  # while (ik < 1):
    ...
    #buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, best_chislo3)
    # buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, best_chislo4)
    # buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, best_chislo5)
    buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo1)
    buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo2)
    buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo3)
    buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo4)
    buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo5)
    buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo6)
    buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo7)
    buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo8)
    buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo9)
    buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo10)
    # buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo11)
    # buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo12)
    # buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo13)
    # buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo14)
    # buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo15)
    # buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo16)
    # buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo17)
    # buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo18)
    # buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo19)
    # buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo20)
    # buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo21)
    # buf_play_chisla = funct_obnuleniaja_chisla(buf_play_chisla, bad_chislo22)
    ...
    while (steps < len(viborka)):
        key = viborka[steps]
        key1 = key
        dubl_list = dubl_finder(key, dubl_list)
        dubl_list2 = dubl_finder2(key, dubl_list2)
        dubl_list3 = dubl_finder3(key, dubl_list3)
        dubl_list4 = dubl_finder4(key, dubl_list4)
        ...
        #funct_obnulenia(buf_play_chisla, steps, 210)
    ...
    best_chisla_list = sort_ed(dic_ed)
    best_chislo1  =  best_chisla_list[0][1][3]
    best_chislo2 = best_chisla_list[1][1][3]
    best_chislo3 = best_chisla_list[2][1][3]
    best_chislo4 = best_chisla_list[3][1][3]
    best_chislo5 = best_chisla_list[4][1][3]
    hudsh_chisla_list = sort_ed_hud(dic_ed)
    bad_chislo1 = hudsh_chisla_list[0][1][3]
    bad_chislo2 = hudsh_chisla_list[1][1][3]
    bad_chislo3 = hudsh_chisla_list[2][1][3]
    bad_chislo4 = hudsh_chisla_list[3][1][3]
    bad_chislo5 = hudsh_chisla_list[4][1][3]
    bad_chislo6 = hudsh_chisla_list[5][1][3]
    bad_chislo7 = hudsh_chisla_list[6][1][3]
    bad_chislo8 = hudsh_chisla_list[7][1][3]
    bad_chislo9 = hudsh_chisla_list[8][1][3]
    bad_chislo10 = hudsh_chisla_list[9][1][3]
    bad_chislo11 = hudsh_chisla_list[10][1][3]
    bad_chislo12 = hudsh_chisla_list[11][1][3]
    bad_chislo13 = hudsh_chisla_list[12][1][3]
    bad_chislo14 = hudsh_chisla_list[13][1][3]
    bad_chislo15 = hudsh_chisla_list[14][1][3]
    bad_chislo16 = hudsh_chisla_list[15][1][3]
    bad_chislo17 = hudsh_chisla_list[16][1][3]
    bad_chislo18 = hudsh_chisla_list[17][1][3]
    bad_chislo19 = hudsh_chisla_list[18][1][3]
    bad_chislo20 = hudsh_chisla_list[19][1][3]
    bad_chislo21 = hudsh_chisla_list[20][1][3]
    bad_chislo22 = hudsh_chisla_list[21][1][3]
    print('best chisla', best_chislo1,best_chislo2 ,best_chislo3, best_chislo4, best_chislo5)
...
summa_of_duble = dubl_list[1]

passiv_of_duble = dubl_list[2]
...
passiv_of_duble_2 = dubl_list2[2]
print('passiv_of_duble_2:',passiv_of_duble_2 )
print('amount of duble_2:',dubl_list2[3] )
print('result of_duble_2 :',summa_of_duble_2-passiv_of_duble_2 )

summa_of_duble_3 = dubl_list3[1]

passiv_of_duble_3 = dubl_list3[2]
print('passiv_of_duble_3:',passiv_of_duble_3 )
print('amount of duble_3:',dubl_list3[3] )
print('result of_duble_3 :',summa_of_duble_3-passiv_of_duble_3 )

summa_of_duble_4 = dubl_list4[1]

passiv_of_duble_4 = dubl_list4[2]
print('passiv_of_duble_4:',passiv_of_duble_4 )
print('amount of duble_4:',dubl_list4[3] )
print('result of_duble_4 :',summa_of_duble_4-passiv_of_duble_4 )

summa_of_duble_5 = dubl_list5[1]

passiv_of_duble_5 = dubl_list5[2]
print('passiv_of_duble_5:',passiv_of_duble_5 )
print('amount of duble_5:',dubl_list5[3] )
print('result of_duble_5 :',summa_of_duble_5-passiv_of_duble_5 )

summa_of_duble_6 = dubl_list6[1]

passiv_of_duble_6 = dubl_list6[2]
print('passiv_of_duble_6:',passiv_of_duble_6 )
print('amount of duble_6:',dubl_list6[3] )
print('result of_duble_6 :',summa_of_duble_6-passiv_of_duble_6 )

summa_of_duble_7 = dubl_list7[1]

passiv_of_duble_7 = dubl_list7[2]
