...
i = 0
next_nol = 0
for i in range(500, 753):  # while (ik < 1):
    ik = ik + 1
    ...
    while (steps < len(viborka)):
        ...
        if (key1 == tecuchajaStavka) and razreshenie_na_stavku:
            ...
            print(steps, '      vyigrysh n:', kolichestvoVyigrashey, '#', 'vyigrysh vypal na: ', key1, '#  shag:',
                  steps)
    ...
    print('real pribul', sum_of_win - (chislo_levyh_stavok))
    prybyl_rel = sum_of_win - (chislo_levyh_stavok)
    ...
    print('posledniy interval iz shagov', list_of_win_proverki_1[0])
